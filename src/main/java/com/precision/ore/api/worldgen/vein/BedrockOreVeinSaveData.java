...
public class BedrockOreVeinSaveData extends WorldSavedData {
	...
	public void readFromNBT(NBTTagCompound nbt) {
		...
		for (int i = 0; i < veinList.tagCount(); i++) {
			...
			if (coords != null) {
				BedrockOreVeinHandler.OreVeinWorldEntry info =
						BedrockOreVeinHandler.OreVeinWorldEntry.readFromNBT(tag.getCompoundTag("oreInfo"));
	...
	public @Nonnull NBTTagCompound writeToNBT(@Nonnull NBTTagCompound nbt) {
		...
		for (Table.Cell<ChunkPosDimension, Integer, BedrockOreVeinHandler.OreVeinWorldEntry> e :
