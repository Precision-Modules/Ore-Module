...
public class OreMetaItems {
	...
	public static void init() {
		...
		DRILL_HEAD = ITEMS.addItem(0, "drill_head")
				.addComponents(new DrillHeadBehavior())
				.setMaxStackSize(1);
		PRIMITIVE_DRILL = ITEMS.addItem(1, "primitive_drill")
				.addComponents(PrimitiveDrillBehavior.INSTANCE)
				.setMaxStackSize(1);
		PROSPECTOR_LV = ITEMS.addItem(2, "prospector.lv")
				.addComponents(
						ElectricStats.createElectricItem(100_000L, GTValues.LV),
						new ProspectorScannerBehavior(2, GTValues.LV))
				.setMaxStackSize(1);
		PROSPECTOR_HV = ITEMS.addItem(3, "prospector.hv")
				.addComponents(
						ElectricStats.createElectricItem(1_600_000L, GTValues.HV),
						new ProspectorScannerBehavior(3, GTValues.HV))
				.setMaxStackSize(1);
		PROSPECTOR_LUV = ITEMS.addItem(4, "prospector.luv")
				.addComponents(
						ElectricStats.createElectricItem(1_000_000_000L, GTValues.LuV),
