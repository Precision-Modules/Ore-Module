package precision.ore.common.prospector;
...
public class ProspectorApp extends AbstractApplication implements SearchComponent.IWidgetSearch<String> {
    ...
    public ProspectorApp(int mode, int layer) {
    ...
    public AbstractApplication createAppInstance(TerminalOSWidget os, boolean isClient, NBTTagCompound nbt) {
        ProspectorApp app = new ProspectorApp(mode, layer);
    ...
    public AbstractApplication initApp() {
        ...
        this.widgetProspectingMap = new WidgetProspectingMap(0, offset + (7 - chunkRadius) * 16, chunkRadius, this.widgetOreList, mode, layer, 1);
        if (isClient) {
