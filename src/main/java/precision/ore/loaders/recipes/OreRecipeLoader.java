...
public class OreRecipeLoader {
    ...
    public static void init(){
        ...
        ModHandler.addMirroredShapedRecipe("primitive_drill", PRIMITIVE_DRILL.getStackForm(),
                "  S", "FS ", "FF ",
                'S', Items.STICK,
                'F', Items.FLINT);

        for (MetaItem<?>.MetaValueItem batteryItem : ToolRecipeHandler.batteryItems.get(GTValues.LV)) {
            ModHandler.addShapedEnergyTransferRecipe("prospector.lv_" + batteryItem.unlocalizedName, PROSPECTOR_LV.getStackForm(),
        ...
        for (MetaItem<?>.MetaValueItem batteryItem : ToolRecipeHandler.batteryItems.get(GTValues.HV)) {
            ModHandler.addShapedEnergyTransferRecipe("prospector.hv_" + batteryItem.unlocalizedName, PROSPECTOR_HV.getStackForm(),
                    batteryItem::isItemEqual, true, true,
                    "SPE", "CDC", "PBP",
        ...
        for (MetaItem<?>.MetaValueItem batteryItem : ToolRecipeHandler.batteryItems.get(GTValues.LuV)) {
            ModHandler.addShapedEnergyTransferRecipe("prospector.luv_" + batteryItem.unlocalizedName, PROSPECTOR_LUV.getStackForm(),
                    batteryItem::isItemEqual, true, true,
